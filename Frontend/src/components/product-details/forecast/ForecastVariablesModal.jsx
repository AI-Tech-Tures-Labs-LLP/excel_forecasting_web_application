...
const ForecastVariablesModal = ({
  ...
  // State for the dynamic calculation modal
  ...
  // Complete Dynamic Calculation Modal Component
        ...
        switch (type) {
          case "store":
            return {
              ...
              formula:
                "Trend = (TY Unit Sales - LY Unit Sales) / LY Unit Sales",
            };
          case "com":
            return {
              tyComSales: data?.ty_com_sales_unit_selected_month_sum || 0,
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm">
                    ...
                    differs from stored total (
                    {totalRecommended?.toLocaleString()}). Additional business
                    rules may apply.
                  </p>
                </div>
              </div>
  ...
  }, [showVariablesModal, dynamicModalState.isOpen, setShowVariablesModal]);
  ...
  return (
    <>
      ...
      <DynamicCalculationModal
        isOpen={dynamicModalState.isOpen}
        onClose={closeDynamicModal}
        data={dynamicModalState.data}
        type={dynamicModalState.type}
        modalType={dynamicModalState.modalType}
        forecastMonth={dynamicModalState.forecastMonth}
      />
    </>
  );
};
