...
const RegisterPage = () => {
  ...
  return (
    <ProtectedRoute requiredPermission="admin">
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-white rounded-xl shadow-xl p-8">
          {/* Back to Dashboard Button - Top Left of Form */}
          <div className="mb-6">
            <Link
              to="/dashboard"
              className="inline-flex items-center gap-2 px-3 py-2 text-indigo-600 hover:text-indigo-700 font-medium transition-colors hover:bg-indigo-50 rounded-lg"
            >
